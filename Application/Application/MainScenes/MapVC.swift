...
class MapVC: UIViewController {
    ...
    var users: [PlacesModel] = [
        PlacesModel(image: UIImage(named: "Süleymaniye Camii"), name: "Süleymaniye Camii",place: "İstanbul"),
        PlacesModel(image: UIImage(named: "Colleseum2"), name: "Colleseum",place: "Rome"),
        PlacesModel(image: UIImage(named: "Süleymaniye Camii"), name: "Süleymaniye Camii",place: "İstanbul"),
    ...
    private lazy var collectionView:UICollectionView = {
        ...
        cv.register(MapVCCell.self, forCellWithReuseIdentifier: "cell")
...
extension MapVC:UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! MapVCCell
